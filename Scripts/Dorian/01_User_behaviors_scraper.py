...
def extract_user_behaviour(driver, date_obj: date) -> dict | None:
    try:
        ...
        print(f"⚠️ StaleElementReferenceException beim Zugriff auf Labels bei {date_obj}")
        return None
...
if __name__ == '__main__':
    ...
    csv_handler = CSVFileHandler(
        ...
        headers=["Datum", "Seitenaufrufe", "Nutzer Insgesamt", "Durchschn. Zeit auf der Seite", "Absprungrate", "Seiten / Sitzung"]
    )
